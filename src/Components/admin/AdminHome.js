    ...
    <div className="container-fluid">
      <div className="row">
        <div className="col-3 leftside">
          <ul className="nav flex-column mentor">  Mentors 
          ...
          <ul className="nav flex-column mentor course">  Courses
            <li className="nav-item">
          ...
          <ul className="nav flex-column mentor course">  Users 
            <li className="nav-item">
       ...
       <Switch>
        ...
        <Route path='/admin/updatecourseById' component={UpdateById}></Route>
